...
public class sftt {
    ...
    public String toString() {
        return "sftt{" + "Matricule=" + Matricule + ", Nom=" + Nom + ", Cnss=" + Cnss + ", DateNaissance=" + DateNaissance + ", Sbase=" + Sbase + ", Libelle=" + Libelle + ", DateRec=" + DateRec + ", Effet1=" + Effet1 + ", Effet2=" + Effet2 + ", Service=" + Service + ", CIN=" + CIN + '}';
    }
